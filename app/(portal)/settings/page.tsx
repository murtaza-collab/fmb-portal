                ...
                <div key={group} className="mb-2">
                  ...
                  {TABS.filter((t) => t.group === group).map((tab) => (
                    <button key={tab.key} onClick={() => setActiveTab(tab.key)} className="w-100 text-start btn btn-sm"
                      style={{ borderRadius: '8px', marginBottom: '2px', background: activeTab === tab.key ? '#d4a032' : 'transparent',
            ...
            <div className="card-body p-3">
              ...
              <div className="d-flex align-items-center justify-content-between mb-3">
                <div className="d-flex align-items-center gap-2">
                  <i className={`bi ${currentTab?.icon}`} style={{ fontSize: '18px', color: '#d4a032' }} />
                ...
                {showAddButton && (
                  <div className="d-flex gap-2">
                    ...
                    <button onClick={() => (activeTab === 'thaali_numbers' ? setShowThaaliModal(true) : openAdd())}
                      className="btn btn-sm" style={{ background: '#d4a032', color: '#fff', borderRadius: '8px', fontSize: '13px', fontWeight: 600 }}>
              ...
              {loading ? (
                ...
                <div>
                  ...
                  <div className="table-responsive">
                    <table className="table table-hover" style={{ fontSize: '13px' }}>
                      ...
                      <tbody>
                        {computedFYs.map((fy) => (
                          <tr key={fy.hijriYear} style={{ background: fy.isCurrentFY ? '#d4a03208' : undefined }}>
                            <td>
                              <span style={{ fontWeight: 700, color: fy.isCurrentFY ? '#d4a032' : 'var(--bs-body-color)' }}>{fy.hijriYear}H</span>
                              {fy.isCurrentFY && <span className="badge ms-2" style={{ background: '#d4a03220', color: '#d4a032', fontSize: '10px' }}>Current</span>}
                            </td>
                ...
                <div style={{ maxWidth: 800 }}>
                  ...
                  <div className="card mb-4 border-0 shadow-sm">
                    <div className="card-header" style={{ background: '#d4a032', color: '#fff', borderRadius: '8px 8px 0 0' }}>
                          ...
                          {CUTOFF_PRESETS.map((h) => (
                            <button key={h} onClick={() => setKitchenSettings({ ...kitchenSettings, customization_cutoff_hours: h })} className="btn btn-sm"
                              style={{ borderRadius: 20, fontSize: 13, fontWeight: 600, padding: '5px 16px',
                                background: kitchenSettings.customization_cutoff_hours === h ? '#d4a032' : 'var(--bs-tertiary-bg)',
                  ...
                  <button onClick={saveKitchenSettings} disabled={saving} className="btn btn-lg w-100"
                    style={{ background: '#d4a032', color: '#fff', borderRadius: '8px', fontSize: '14px', fontWeight: 600 }}>
                      ...
                      <tbody>
                        {filteredThaaliNumbers.length === 0 ? (
                          ...
                          <tr key={t.id}>
                            ...
                            <td>
                              {t.assigned
                                ? <span className="badge" style={{ background: '#d4a03220', color: '#d4a032', fontWeight: 600, fontSize: '11px' }}>Assigned</span>
                    ...
                    <div key={sec.id} className="mb-2" style={{ border: '1px solid var(--bs-border-color)', borderRadius: 10, overflow: 'hidden' }}>
                      <div className="d-flex align-items-center px-3 py-2" style={{ background: 'var(--bs-body-bg)' }}>
                        ...
                        <button className="btn btn-sm me-2"
                          style={{ background: sec.distributors.length > 0 ? '#d4a03215' : 'var(--bs-tertiary-bg)',
                            color: sec.distributors.length > 0 ? '#d4a032' : 'var(--bs-secondary-color)',
                        ...
                        <div className="d-flex gap-1">
                          <button onClick={() => openEdit(sec)} className="btn btn-sm"
                            style={{ padding: '3px 8px', background: '#d4a03215', color: '#d4a032', border: 'none', borderRadius: '6px' }}>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 9999, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '60px 16px' }}
          ...
          <div style={{ background: 'var(--bs-body-bg)', borderRadius: '12px', width: '100%', maxWidth: '440px', boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}
            ...
            <div style={{ padding: '12px 20px', borderTop: '1px solid var(--bs-border-color)', display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              ...
              <button onClick={saveRow} disabled={saving} className="btn btn-sm" style={{ background: '#d4a032', color: '#fff', borderRadius: 8, fontSize: 13, fontWeight: 600 }}>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 9999, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '60px 16px' }}
          ...
          <div style={{ background: 'var(--bs-body-bg)', borderRadius: 12, width: '100%', maxWidth: 440, boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}
            ...
            <div style={{ padding: '12px 20px', borderTop: '1px solid var(--bs-border-color)', display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              ...
              <button onClick={saveThaaliNumber} disabled={saving} className="btn btn-sm" style={{ background: '#d4a032', color: '#fff', borderRadius: 8, fontSize: 13, fontWeight: 600 }}>
          ...
          <div style={{ padding: '10px 16px', background: '#2a2a2a', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              <a href={previewUrl} download={`thaali-stickers-${new Date().toISOString().slice(0,10)}.pdf`}
                className="btn btn-sm" style={{ background: '#d4a032', color: '#fff', borderRadius: 8, fontSize: 13, fontWeight: 600, textDecoration: 'none' }}>
                Download PDF
              </a>
